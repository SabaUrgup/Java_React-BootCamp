...
//injection bağımlılıkları yönetmek için kullanılır.
	private ProductDao productDao;	//productDao injection'ı yapıldı
	
	@Autowired //ProductDao'nun somut sınıfını arar ve onu newleyip geri döndürür.
	public ProductManager(ProductDao productDao)	//constructor injection
	{
		super();
		this.productDao = productDao;
	}
	//interface'ler new'lenemez. Bunun için autowired kullandık ve çalıştırdık.
