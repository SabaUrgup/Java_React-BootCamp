...
//Veri tabanindan ürünün bir kategorisi var olduğunu anlariz, dolayısı ile --> ManyToOne
    @ManyToOne()
	 ...
	 * id alanı olduğunu --> @Id
	 * id alaninin nasil olusacagini --> @GeneratedValue(strategy = GenerationType.IDENTITY)
	 * hangi satıra denk geldiğini gösterir --> @Column
	 * iliski olan tablo ile iliskisinin nasıl gerçekleştiğini gösterir--> @ManyToOne()
	 */
